...
const News = () => {
  const newsArticles = [
    ...
    {
      id: 2,
      title: "Неделя баварской кухни - с 20 по 27 марта",
      excerpt: "Окунитесь в мир аутентичных баварских вкусов! Специальное меню с традиционными блюдами из Мюнхена и окрестностей...",
      date: "2024-03-10",
      author: "Анна Шмидт",
      category: "События",
      readTime: "2 мин"
    ...
    {
      id: 6,
      title: "Мастер-класс по приготовлению шницеля",
      excerpt: "Научитесь готовить идеальный венский шницель от нашего шеф-повара. Ограниченное количество мест...",
      date: "2024-02-15",
      author: "Штефан Мюллер",
      category: "Кулинария",
      readTime: "5 мин"
  ...
  const getCategoryColor = (category: string) => {
    const colors = {
      ...
      "Кулинария": "bg-green-100 text-green-800"
    };
